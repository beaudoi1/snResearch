...
res=Table.read('data/Visit 5/residual.flm', format='ascii')
...
guesses=[-.392,FeIIa,1.46,-.243,FeIIb,1.38,-.504,FeIIc,1.51,-.372,MnIIa,1.7,-.460,MnIIb,1.71,-.685,MgIIa,1.72,-.630,MgIIb,1.6,-.033, MgIa, 1.99]
...
t.write('data/Visit 5/EQW.dat',format='ascii')
